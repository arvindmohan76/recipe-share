/*
  # Add More Cuisine Types and Sample Recipes

  1. New Sample Recipes
  ...
  2. Updated Existing Recipes
    - Set more specific cuisine types for existing recipes
    - Spanish, German, British, Jamaican, Polish cuisines

  3. Comprehensive Cuisine Coverage
    - 25 different cuisine types total
    - Authentic recipes with detailed instructions
    - Cultural cooking techniques and tips
*/
...
(
  'Brazilian Feijoada',
  'Brazil national dish featuring black beans slowly simmered with smoky meats, creating a rich, hearty stew that embodies the soul of Brazilian comfort food.',
  '[
  ...
  '[
    {"step": 1, "instruction": "Soak black beans overnight, then cook with bay leaves until tender, about 2 hours.", "tips": "Do not add salt while cooking beans as it toughens them."},
...
(
  'Ethiopian Doro Wat',
  'Ethiopia beloved chicken stew simmered in berbere spice blend and rich onion base, creating layers of complex heat and aromatic warmth that define authentic Ethiopian cuisine.',
  '[
  ...
  '[
    {"step": 1, "instruction": "Slowly cook diced onions in dry pan until deep golden and caramelized, about 45 minutes.", "tips": "This creates the flavor foundation - do not rush this step."},
...
(
  'Peruvian Ceviche',
  'Fresh fish cooked in zesty lime juice with red onions, cilantro, and ají peppers, creating a bright, refreshing dish that captures the essence of Peru coastal cuisine.',
  '[
  ...
  '[
    ...
    {"step": 3, "instruction": "Blend lime juice, ají amarillo, garlic, and ginger until smooth.", "tips": "This creates the leche de tigre - tiger milk marinade."},
    {"step": 4, "instruction": "Toss fish with lime mixture and salt, marinate 15-20 minutes until opaque.", "tips": "Do not over-marinate or fish becomes mushy."},
...
(
  'Vietnamese Pho Bo',
  'Aromatic beef broth simmered with star anise, cinnamon, and ginger, served with tender rice noodles and fresh herbs for Vietnam most beloved comfort soup.',
  '[
  ...
  '[
    ...
    {"step": 5, "instruction": "Cook rice noodles according to package directions.", "tips": "Do not overcook noodles as they continue cooking in hot broth."},
...
(
  ...
  '[
    ...
    {"step": 2, "instruction": "Sear beef strips in hot butter until browned, remove and set aside.", "tips": "Do not overcrowd pan - work in batches for proper browning."},
