/*
  # Add diverse international recipe samples

  1. New Recipe Data
    - Korean Bibimbap Bowl with authentic ingredients and techniques
    - Greek Moussaka with traditional layering method
    - Lebanese Hummus with tahini and proper texture tips
    - Moroccan Chicken Tagine with preserved lemons and spices
    - Brazilian Feijoada with smoky meats and traditional sides
    - Ethiopian Doro Wat with berbere spice blend
    - Peruvian Ceviche with proper acid-cooking technique
    - Vietnamese Pho Bo with long-simmered aromatic broth
    - Turkish Baklava with phyllo pastry and honey syrup
    - Russian Beef Stroganoff with sour cream sauce

  2. Recipe Updates
    - Update existing recipes to have more specific cuisine classifications
    - Ensure diverse representation of world cuisines
*/
