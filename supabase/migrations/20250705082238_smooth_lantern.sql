/*
  # Fix AI Recommendations Support

  1. Updates
    - Add support for AI recommendation types
    - Add reasoning field for AI explanations
    - Create indexes for better performance
    - Add cleanup function for old recommendations

  2. Security
    - Ensure proper access control
    - Add function for retrieving AI recommendations
*/
